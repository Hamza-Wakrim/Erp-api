                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: {{$color}};color:{{$font_color}}">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        <div data-v-f2a183a6="" class="d-title">{{__('Delivery Note')}}</div>

                                        <div class="float-right mb-5">
                                            {!! DNS2D::getBarcodeHTML(route('invoice.link.copy',\Crypt::encrypt($deliveryNote->invoice_id)), "QRCODE",2,2) !!}
                                        </div>
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                <td>{{__('Number')}}:</td>
                                                <td>{{Utility::deliveryNoteNumberFormat($settings,$deliveryNote->invoice_id)}}</td>
                                            </tr>
                                            <tr>
                                                <td>{{__('Issue Date')}}:</td>
                                                <td>{{Utility::dateFormat($settings,$deliveryNote->issue_date)}}</td>
                                            </tr>
                                            <tr>
                                                <td>{{__('Due Date')}}:</td>
                                                <td>{{Utility::dateFormat($settings,$deliveryNote->due_date)}}</td>
                                            </tr>
                                            @if(!empty($customFields) && count($deliveryNote->customField)>0)
                                                @foreach($customFields as $field)
                                                    <tr>
                                                        <td>{{$field->name}} :</td>
                                                        <td> {{!empty($deliveryNote->customField)?$deliveryNote->customField[$field->id]:'-'}}</td>
                                                    </tr>
                                                @endforeach
                                            @endif
                                            </tbody>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-tr" style="background: {{$color}};color:{{$font_color}}">
                                                ...
                                                @if($deliveryNote->discount_apply==1)
                                            ...
                                            <div class="d-table-body">
                                                @if(isset($deliveryNote->itemData) && count($deliveryNote->itemData) > 0)
                                                    @foreach($deliveryNote->itemData as $key => $item)
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                                ...
                                                <div class="d-table-td w-2">
                                                    <pre data-v-f2a183a6="">{{$deliveryNote->totalQuantity}}</pre>
                                                </div>
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">{{Utility::priceFormat($settings,$deliveryNote->totalRate)}}</pre>
                                                </div>
                                                <div class="d-table-td w-5">
                                                    <pre data-v-f2a183a6="">{{Utility::priceFormat($settings,$deliveryNote->totalTaxPrice) }}</pre>
                                                </div>
                                                @if($deliveryNote->discount_apply==1)
                                                    <div class="d-table-td w-2">
                                                        <pre data-v-f2a183a6="">{{Utility::priceFormat($settings,$deliveryNote->totalDiscount)}}</pre>
                                                    </div>
                                                @else
                                                    <div class="d-table-td w-2">
                                                        <pre data-v-f2a183a6="">-</pre>
                                                ...
                                                <div class="d-table-td w-4 text-right">
                                                    <span>{{Utility::priceFormat($settings,$deliveryNote->getSubTotal())}}
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,$deliveryNote->getSubTotal())}}</div>
                                                    </div>
                                                    @if($deliveryNote->getTotalDiscount())
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">{{__('Discount')}}:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,$deliveryNote->getTotalDiscount())}}</div>
                                                        </div>
                                                    @endif
                                                    @if(!empty($deliveryNote->taxesData))
                                                        @foreach($deliveryNote->taxesData as $taxName => $taxPrice)
                                                            <div data-v-f2a183a6="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,$deliveryNote->getSubTotal()-$deliveryNote->getTotalDiscount()+$deliveryNote->getTotalTax())}}</div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Paid')}}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,($deliveryNote->getTotal()-$deliveryNote->getDue())-($deliveryNote->deliveryNoteTotalCreditNote()))}}</div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Credit Note')}}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,($deliveryNote->deliveryNoteTotalCreditNote()))}}</div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Due Amount')}}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,$deliveryNote->getDue())}}</div>
                                                    </div>
                                                </div>
                                            </div>
