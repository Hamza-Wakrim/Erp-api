                ...
                <ul class="navbar-nav navbar-nav-docs">
                    @if( Gate::check('show hrm dashboard') || Gate::check('show project dashboard') || Gate::check('show account dashboard'))
                        <li class="nav-item">
                            ...
                            <div
                                class="collapse {{ (Request::segment(1) == 'account-dashboard' || Request::segment(1) == 'project-dashboard' || Request::segment(1) == 'hrm-dashboard')?'show':''}}"
                                id="navbar-dashboard">
                    ...
                    @else
                        @if( Gate::check('manage user') || Gate::check('manage role'))
                            <li class="nav-item">
                                ...
                                <div
                                    class="collapse {{ (Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'clients')?'show':''}}"
                                    id="navbar-staff">
                                    <ul class="nav flex-column">
                                        @can('manage user')
                                                        ...
                                                        <ul class="nav flex-column">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li">
                                                                    ...
                                                                    <div
                                                                        class="submenu-ul {{ (Request::segment(1) == 'bugstatus' || Request::segment(1) == 'project-task-stages') ? 'show' : 'collapse'}}"
                                                ...
                                                <div class="collapse show" id="navbar-accounting8" style="">
                                                    <ul class="nav flex-column">
                                                        <ul class="nav flex-column">
                                                            ...
                                                            <li class="nav-item submenu-li ">
                                                                <a class="nav-link {{ (Request::segment(1) == 'setsalary' || Request::segment(1) == 'payslip') ? 'active' : 'collapsed'}}"
                                                                ...
                                                                <div
                                                                    class="submenu-ul {{ (Request::segment(1) == 'setsalary' || Request::segment(1) == 'payslip') ? 'show' : 'collapse'}}"
                                                ...
                                                <div class="collapse show" id="navbar-hr" style="">
                                                    <ul class="nav flex-column">
                                                        <li class="nav-item submenu-li ">
                                                            ...
                                                            <div
                                                                class="submenu-ul {{ (Request::segment(1) == 'leave' || Request::segment(1) == 'attendanceemployee') ? 'show' :'collapse'}}"
                                                                                ...
                                                                                <ul class="nav flex-column">
                                                                                    <ul class="nav flex-column">
                                                                                        <li class="nav-item submenu-li ">
                                                                                            ...
                                                                                            <div
                                                                                                class="submenu-ul {{ (Request::segment(1) == 'attendanceemployee') ? 'show' : 'collapse'}}"
                                                    ...
                                                    <ul class="nav flex-column">
                                                        <ul class="nav flex-column">
                                                            <li class="nav-item submenu-li ">
                                                                ...
                                                                <div
                                                                    class="submenu-ul {{ (Request::segment(1) == 'indicator' || Request::segment(1) == 'appraisal' || Request::segment(1) == 'goaltracking') ? 'show' : 'collapse'}}"
                                                    ...
                                                    <ul class="nav flex-column">
                                                        <ul class="nav flex-column">
                                                            <li class="nav-item submenu-li ">
                                                                ...
                                                                <div
                                                                    class="submenu-ul {{ (Request::segment(1) == 'trainer' || Request::segment(1) == 'training') ? 'show' : 'collapse'}}"
                                                    ...
                                                    <ul class="nav flex-column">
                                                        <ul class="nav flex-column">
                                                            <li class="nav-item submenu-li">
                                                                ...
                                                                <div
                                                                    class="submenu-ul {{ (Request::segment(1) == 'job' || Request::segment(1) == 'job-application' || Request::segment(1) == 'candidates-job-applications' || Request::segment(1) == 'job-onboard' || Request::segment(1) == 'custom-question' || Request::segment(1) == 'interview-schedule' || Request::segment(1) == 'career') ? 'show' : 'collapse'}}"
                                                        ...
                                                        <ul class="nav flex-column">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li ">
                                                                    ...
                                                                    <div
                                                                        class="submenu-ul collapse{{ (Request::segment(1) == 'reports-monthly-attendance' || Request::segment(1) == 'reports-leave' || Request::segment(1) == 'reports-payroll') ? 'show' : ''}}"
                                                                        id="hr-report" style="">
                                                                        <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div
                                        ...
                                        <ul class="nav flex-column">
                                                        ...
                                                        <ul class="nav flex-column">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li ">
                                                                    ...
                                                                    <div
                                                                        class="submenu-ul {{(Request::segment(1) == 'bank-account' || Request::segment(1) == 'bank-transfer')? 'show' :'collapse'}}"
                                            ...
                                            @endif
                                            @if( Gate::check('manage invoice') ||  Gate::check('manage revenue') ||  Gate::check('manage credit note') || Gate::check('manage delivery note'))
                                                <li class="nav-item">
                                                    <div class="collapse show" id="income-navbar" style="">
                                                        <ul class="nav flex-column">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li ">
                                                                    <a class="nav-link {{(Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note' || Request::segment(1) == 'delivery-note')? 'active' :'collapsed'}}"
                                                                    ...
                                                                    <div
                                                                        class="submenu-ul {{(Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note' || Request::segment(1) == 'delivery-note')? 'show' :'collapse'}}"
                                                                        id="income-nav" style="">
                                                                        <ul class="nav flex-column">
                                                                            @can('manage invoice')
                                                                            ...
                                                                            @can('manage delivery note')
                                                                                <li class="nav-item {{ (Request::route()->getName() == 'delivery-note.index' || Request::route()->getName() == 'delivery-note.create' || Request::route()->getName() == 'delivery-note.edit' || Request::route()->getName() == 'delivery-note.show') ? ' active' : '' }}">
                                                                                    <a href="{{ route('delivery-note.index') }}"
                                                                                       class="nav-link">{{ __('Delivery Note') }}</a>
                                                                                </li>
                                                                            @endcan
                                                                            @can('manage revenue')
                                                        ...
                                                        <ul class="nav flex-column">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li ">
                                                                    ...
                                                                    <div
                                                                        class="submenu-ul {{(Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note')? 'show' :'collapse'}}"
                                                        ...
                                                        <ul class="nav flex-column">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li ">
                                                                    ...
                                                                    <div
                                                                        class="submenu-ul {{(Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance')? 'show' :'collapse'}}"
                                                        ...
                                                        <ul class="nav flex-column">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li ">
                                                                    ...
                                                                    <div
                                                                        class="submenu-ul {{((Request::segment(1) == 'report' || Request::segment(1) == 'transaction') &&  Request::segment(2) != 'ledger' &&  Request::segment(2) != 'balance-sheet' &&  Request::segment(2) != 'trial-balance')? 'show' :'collapse'}}"
                                                                        id="report-nav" style="">
                                                                        <ul class="nav flex-column">
                                                        ...
                                                        <ul class="nav flex-column">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item submenu-li ">
                                                                    ...
                                                                    <div
                                                                        class="submenu-ul {{(Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type')? 'show' :'collapse'}}"
