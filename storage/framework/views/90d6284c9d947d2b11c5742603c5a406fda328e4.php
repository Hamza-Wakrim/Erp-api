                                    ...
                                    <div data-v-e23d9750="" class="row">
                                        <div data-v-e23d9750="" class="col-66">
                                            <h1 data-v-e23d9750="" class="fancy-title tu mb5"
                                                style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                                <?php echo e(__('INVOICE')); ?></h1>
                                            <div >
                                                ...
                                                <tbody data-v-e23d9750="">
                                                    <tr data-v-e23d9750="">
                                                        <td data-v-e23d9750="" class="tu fwb">
                                                            <?php echo e(__('Number')); ?>:</td>
                                                        <td data-v-e23d9750="" class="text-right">
                                                            <?php echo e(Utility::invoiceNumberFormat($settings, $invoice->invoice_id)); ?>

                                                        </td>
                                                    </tr>
                                                    <tr data-v-e23d9750="">
                                                        <td data-v-e23d9750="" class="tu fwb">
                                                            <?php echo e(__('Issue Date')); ?>:</td>
                                                        <td data-v-e23d9750="" class="text-right">
                                                    ...
                                                    <tr data-v-e23d9750="">
                                                        <td data-v-e23d9750="" class="tu fwb">
                                                            <?php echo e(__('Due Date')); ?>:</td>
                                                        <td data-v-e23d9750="" class="text-right">
                                                            <?php echo e(Utility::dateFormat($settings, $invoice->due_date)); ?>
                                    ...
                                    <div data-v-e23d9750="" class="d-table">
                                        <div data-v-e23d9750="" class="d-table">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-tr"
                                                ...
                                                <div class="d-table-th w-4 text-right"><?php echo e(__('Price')); ?><br><small
                                                        class="text-danger"><?php echo e(__('before tax & discount')); ?></small>
                                                </div>
                                            </div>
                                                    ...
                                                    <?php $__currentLoopData = $invoice->itemData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <div class="d-table-tr"
                                                            ...
                                                            <div class="d-table-td w-3">
                                                                <pre
                                                                    data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings, $item->price)); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6="">
                                                            ...
                                                            <?php if($invoice->discount_apply == 1): ?>
                                                                <div class="d-table-td w-2">
                                                                    <pre
                                                                        data-v-f2a183a6=""><?php echo e($item->discount != 0 ? Utility::priceFormat($settings, $item->discount) : '-'); ?></pre>
                                                                </div>
                                                            <?php else: ?>
                                                                <div class="d-table-td w-2">
                                                            ...
                                                            <div class="d-table-td w-3">
                                                                <pre
                                                                    data-v-f2a183a6=""><?php echo e(!empty($item->description) ? $item->description : '-'); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-4 text-right">
                                                                <span><?php echo e(Utility::priceFormat($settings, $item->price * $item->quantity)); ?></span>
                                                            </div>
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php else: ?>
                                            ...
                                            <div class="d-table-tr"
                                                ...
                                                <div class="d-table-td w-3">
                                                    <pre
                                                        data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings, $invoice->totalRate)); ?></pre>
                                                </div>
                                                <div class="d-table-td w-5">
                                                    <pre
                                                        data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings, $invoice->totalTaxPrice)); ?></pre>
                                                </div>
                                                <?php if($invoice->discount_apply == 1): ?>
                                                    <div class="d-table-td w-2">
                                                        <pre
                                                            data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings, $invoice->totalDiscount)); ?></pre>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="d-table-td w-2">
                                                        <pre data-v-f2a183a6="">-</pre>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label">
                                                            <?php echo e(__('Total')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">
                                                            <?php echo e(Utility::priceFormat($settings, $invoice->getSubTotal() - $invoice->getTotalDiscount() + $invoice->getTotalTax())); ?>
...
<?php /**PATH D:\main_file2\resources\views/invoice/templates/template5.blade.php ENDPATH**/ ?>