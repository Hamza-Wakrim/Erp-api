...
Route::get('delivery-note/pdf/{id}', 'DeliveryNoteController@invoice')->name('delivery-note.pdf')->middleware(
    [
        'XSS',
        'revalidate',
    ]
...
Route::group(
    ...
    Route::get('deliver-note/{id}/duplicate', 'DeliveryNoteController@duplicate')->name('delivery-note.duplicate');
    Route::get('delivery-note/{id}/shipping/print', 'DeliveryNoteController@shippingDisplay')->name('delivery-note.shipping.print');
    Route::get('delivery-note/{id}/payment/reminder', 'DeliveryNoteController@paymentReminder')->name('delivery-note.payment.reminder');
    Route::get('delivery-note/index', 'DeliveryNoteController@index')->name('delivery-note.index');
    Route::post('delivery-note/product/destroy', 'DeliveryNoteController@productDestroy')->name('delivery-note.product.destroy');
    Route::post('delivery-note/product', 'DeliveryNoteController@product')->name('delivery-note.product');
    Route::post('delivery-note/customer', 'DeliveryNoteController@customer')->name('delivery-note.customer');
    Route::get('delivery-note/{id}/sent', 'DeliveryNoteController@sent')->name('delivery-note.sent');
    Route::get('delivery-note/{id}/resent', 'DeliveryNoteController@resent')->name('delivery-note.resent');
    Route::get('delivery-note/{id}/payment', 'DeliveryNoteController@payment')->name('delivery-note.payment');
    Route::post('delivery-note/{id}/payment', 'DeliveryNoteController@createPayment')->name('delivery-note.payment');
    Route::post('delivery-note/{id}/payment/{pid}/destroy', 'DeliveryNoteController@paymentDestroy')->name('delivery-note.payment.destroy');
    Route::get('delivery-note/items', 'DeliveryNoteController@items')->name('delivery-note.items');


    Route::resource('delivery-note', 'DeliveryNoteController');
    Route::get('delivery-note/create/{cid}', 'DeliveryNoteController@create')->name('delivery-note.create');
}
);
...
Route::group([
    ...
    Route::get('proposal/{id}/convertToInvoice', 'ProposalController@convertToInvoice')->name('proposal.convertToInvoice');
    Route::get('proposal/{id}/convertToDeliverNote', 'ProposalController@convertToDeliverNote')->name('proposal.convertToDeliverNote');
...
Route::get('export/delivery-note', 'DeliveryNoteController@export')->name('delivery-note.export');
