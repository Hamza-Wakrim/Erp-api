...
class Utility extends Model
{
    public static function settings()
    {
        ...
        $settings = [
            ...
            "invoice_prefix" => "#INVO",
            "deliver_note_prefix" => "#BLO",
            "journal_prefix" => "#JUR",
            "invoice_color" => "ffffff",
            "delivery_note_color" => "ffffff",
            ...
            "delivery_note_template" => "template1",
...
',
    ...
    public static function deliveryNoteNumberFormat($settings, $number)
    {

        return $settings["deliver_note_prefix"] . sprintf("%05d", $number);
    }
    ...
    public static function customerDeliveryNoteNumberFormat($number)
    {
        $settings = Utility::settings();
